    ...
    <div className="card glass">
        ...
        <div style={{ padding: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                ...
                <span style={{ background: 'rgba(217, 119, 6, 0.15)', color: 'var(--primary)', padding: '0.25rem 0.75rem', borderRadius: '9999px', fontSize: '0.875rem' }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <h1 style={{ 
                        ...
                        Find Your <span style={{ color: 'var(--primary)' }}>New Home</span>
                    </h1>
                    ...
                    <p style={{ 
                        ...
                        Browse our list of great houses and apartments to find the perfect place to live.
                    </p>
            ...
            <div className="container">
                ...
                {error ? (
                    ...
                    <div style={{ textAlign: 'center', padding: '4rem' }}>
                        <div style={{ 
                            width: '40px', height: '40px', border: '3px solid rgba(217, 119, 6, 0.3)',
